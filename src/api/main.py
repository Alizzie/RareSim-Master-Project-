...
# ── Method groups ─────────────────────────────────────────────────────────────
SEMANTIC_METHODS   = {"semantic_resnik_bma", "semantic_lin_bma", "semantic_jiang_conrath_bma"}
...
def extract(req: ExtractRequest):
    ...
    valid_methods = {"dictionary", "biomedical_ner", "fast_hpo_cr", "chatgpt", "phenobrain_api"}
